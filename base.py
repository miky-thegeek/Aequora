...
with open('/home/michele/Downloads/Elenco_Movimenti(2).csv', mode ='r') as fileBank:
    ...
    with open('/home/michele/Downloads/Elenco_Movimenti(1).csv', mode ='r') as fileCard:
        ...
        with open('/home/michele/Downloads/L5BXD33J8AZMG-CSR-20230101000000-20250315235959-20250316052428.CSV', mode ='r') as filePayPal:
            csvFilePayPal = csv.reader(filePayPal)
